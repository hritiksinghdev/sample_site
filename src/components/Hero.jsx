...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center bg-cream overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full pt-32 lg:pt-0">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="font-heading text-[2.8rem] md:text-[3.5rem] lg:text-[4rem] xl:text-[4.5rem] leading-[1.08] text-primary mb-6">
              Statement
              <br />
            ...
            <p className="text-secondary text-base lg:text-[1.05rem] leading-relaxed max-w-md mx-auto lg:mx-0 mb-10 font-light">
          ...
          >
            ...
            <motion.div
              className="hidden lg:block absolute -bottom-6 -left-6 bg-card p-6 shadow-sm border border-border rounded-sm"
