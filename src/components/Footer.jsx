  ...
  return (
    <footer className="bg-primary text-cream">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <motion.div
          className="py-20 lg:py-28 border-b border-white/10"
        ...
        >
          <div className="max-w-xl mx-auto text-center">
            <span className="text-[0.6rem] tracking-[0.35em] uppercase text-gold/70 font-medium">
              Stay in the loop
            </span>
            <h3 className="font-heading text-2xl lg:text-3xl text-white mt-3 mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 bg-white/5 border border-white/15 rounded-sm px-5 py-3 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors duration-300"
              />
              <button className="bg-gold hover:bg-gold/80 text-primary text-[0.7rem] tracking-[0.18em] uppercase px-7 py-3 rounded-sm transition-colors duration-300 font-medium whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
